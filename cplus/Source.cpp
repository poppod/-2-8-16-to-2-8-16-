	...
	if (d1 == 2) {
		...
		case 2:printf_s(" Enter Valuse : \n");
			...
			if (R == 1) {
				...
				OctToBin(d); printf("Answer is(%d.%d%d%d%d%d)%d ", r, a[0], a[1], a[2], a[3], a[4], d2); break;
			}
		...
		case 16:printf_s(" Enter Valuse : \n");
			...
			if (R == 1) {
				...
				OctToHex(d); printf("Answer is(%s.%s)%d", Hex, b, d2); break;
			}
		}
	}
	else if (d1 == 16) {
		...
		case 2:
			...
			if (CheckHex(d) == 1) {
				...
				HexToBin(d); printf("Answer is(%d.%d%d%d%d%d)%d ", r, a[0], a[1], a[2], a[3], a[4], d2); break;
			}
